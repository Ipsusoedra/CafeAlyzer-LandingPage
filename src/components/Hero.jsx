  ...
  return (
    <>
      <div ref={ref} className="flex flex-col lg:flex-row gap-5 px-10 py-10 my-28 md:my-28 lg:my-28">
        <div className="flex flex-col gap-14 lg:w-4/12 md:gap-16 lg:gap-16" data-aos="fade-right">
        ...
        <div className="hidden lg:flex lg:w-8/12 lg:justify-center lg:items-center" data-aos="fade-left">
